...
class StudentListingTable: UIViewController,UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.course.text = self.studentListArr[indexPath.row].course
        cell.roll.text = self.studentListArr[indexPath.row].roll
        cell.branch.text = self.studentListArr[indexPath.row].branch
